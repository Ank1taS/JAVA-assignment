...
class Calculate
{
    ...
    void show()
    {
        ...
        {
            System.out.println("Total days in the month of " + month + " and " + year + " are  31.");
        } 
        else if (month == 4 || month == 6 || month == 9 || month == 11)
        {
            System.out.println("Total days in the month of " + month + " and " + year + " are  30.");
        } 
        else    //for february month
        {
            if(leap())
            {
                System.out.println("Total days in the month of " + month + " and " + year + " are  29.");
 
            }
            else
            {
                System.out.println("Total days in the month of " + month + " and " + year + " are  28.");
